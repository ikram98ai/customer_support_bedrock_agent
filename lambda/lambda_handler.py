...
def lambda_handler(event, context):
    ...
    if function == "customerId":
        ...
        if all(value is not None and value != "" for value in (custId, purchaseId, supportSummary)):
        ...
        if all(value is not None and value != "" for value in (custId, purchaseDate, productDescription)):
